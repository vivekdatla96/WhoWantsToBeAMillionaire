...
public class QuestionTenActivity extends AppCompatActivity {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isCorrectAnswer(selectedRadioButton)) {
                    ...
                    int questionEarnings = 1000000; // Earnings for answering this question correctly
                    Toast.makeText(QuestionTenActivity.this, "Correct! You've won $" + questionEarnings, Toast.LENGTH_SHORT).show();

                    // Update the display to show earnings for this question
                    currentEarnings.setText("Earnings for This Question: $" + questionEarnings);

                    Intent intent = new Intent(QuestionTenActivity.this, VictoryActivity.class);
                    intent.putExtra("QUESTION_EARNINGS", questionEarnings);
                    startActivity(intent);
                    finish(); // End this activity
                } else {
                    // Incorrect answer, go to game over screen
                    Toast.makeText(QuestionTenActivity.this, "Incorrect! Game Over", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(QuestionTenActivity.this, GameOverActivity.class);
    ...
    private boolean isCorrectAnswer(RadioButton selectedRadioButton) {
        return selectedRadioButton.getText().toString().equalsIgnoreCase("Yen");
    }
}
