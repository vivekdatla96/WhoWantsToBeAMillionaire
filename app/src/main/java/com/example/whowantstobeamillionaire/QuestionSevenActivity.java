...
public class QuestionSevenActivity extends AppCompatActivity {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isCorrectAnswer(selectedRadioButton)) {
                    ...
                    int questionEarnings = 100000; // Earnings for answering this question correctly
                    Toast.makeText(QuestionSevenActivity.this, "Correct! You've won $" + questionEarnings, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(QuestionSevenActivity.this, "Incorrect! Game Over", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(QuestionSevenActivity.this, GameOverActivity.class);
    ...
    private boolean isCorrectAnswer(RadioButton selectedRadioButton) {
        return selectedRadioButton.getText().toString().equalsIgnoreCase("Africa");
    }
}
