...
public class QuestionEightActivity extends AppCompatActivity {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isCorrectAnswer(selectedRadioButton)) {
                    ...
                    int questionEarnings = 200000; // Earnings for answering this question correctly
                    Toast.makeText(QuestionEightActivity.this, "Correct! You've won $" + questionEarnings, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(QuestionEightActivity.this, "Incorrect! Game Over", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(QuestionEightActivity.this, GameOverActivity.class);
    ...
    private boolean isCorrectAnswer(RadioButton selectedRadioButton) {
        return selectedRadioButton.getText().toString().equalsIgnoreCase("Great Blue Whale");
    }
}
