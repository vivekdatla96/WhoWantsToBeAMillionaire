...
public class QuestionThreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_three); // Ensure this layout file is correctly named
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isCorrectAnswer(selectedRadioButton)) {
                    ...
                    int questionEarnings = 1000; // Earnings for answering this question correctly
                    Toast.makeText(QuestionThreeActivity.this, "Correct! You've won $" + questionEarnings, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(QuestionThreeActivity.this, "Incorrect! Game Over", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(QuestionThreeActivity.this, GameOverActivity.class);
    ...
    private boolean isCorrectAnswer(RadioButton selectedRadioButton) {
        ...
        // For demonstration, this example assumes the correct answer is "Option B"
        return selectedRadioButton.getText().toString().equalsIgnoreCase("Avocado");
    }
}
