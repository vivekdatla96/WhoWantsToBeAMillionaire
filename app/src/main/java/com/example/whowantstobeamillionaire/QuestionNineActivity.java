...
public class QuestionNineActivity extends AppCompatActivity {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isCorrectAnswer(selectedRadioButton)) {
                    ...
                    int questionEarnings = 500000; // Earnings for answering this question correctly
                    Toast.makeText(QuestionNineActivity.this, "Correct! You've won $" + questionEarnings, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(QuestionNineActivity.this, "Incorrect! Game Over", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(QuestionNineActivity.this, GameOverActivity.class);
    ...
    private boolean isCorrectAnswer(RadioButton selectedRadioButton) {
        return selectedRadioButton.getText().toString().equalsIgnoreCase("J.K. Rowling");
    }
}
