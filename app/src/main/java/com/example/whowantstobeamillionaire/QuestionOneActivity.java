...
public class QuestionOneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_one); // Make sure this is the correct layout
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isCorrectAnswer(selectedRadioButton)) {
                    ...
                    int questionEarnings = 100; // Earnings for answering this question correctly
                    Toast.makeText(QuestionOneActivity.this, "Correct! You've won $" + questionEarnings, Toast.LENGTH_SHORT).show();
                    ...
                    // Incorrect answer, go to game over screen
                    Toast.makeText(QuestionOneActivity.this, "Incorrect! Game Over", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(QuestionOneActivity.this, GameOverActivity.class);
    ...
    private boolean isCorrectAnswer(RadioButton selectedRadioButton) {
        ...
        return selectedRadioButton.getText().toString().equalsIgnoreCase("Ottawa");
    }
}
